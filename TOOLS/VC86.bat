@echo off
title Install Visual C++ Redistributable (x86)
color 1F

echo ============================================
echo Downloading and Installing VC++ Redistributable (x86)
echo ============================================
echo.
...
set "FILE=%TEMP%\vc_redist.x86.exe"

:: Create temp folder
mkdir "%WORKDIR%" >nul 2>&1

echo Downloading VC++ Redistributable x86...
