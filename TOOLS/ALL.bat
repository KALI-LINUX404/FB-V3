...
adb shell rm -rf /sdcard/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/SaveGames > nul 2>&1
...
adb shell rm -rf /data/data/com.pubg.krmobile/databases/* > nul 2>&1
adb shell mv /data/data/com.pubg.krmobile/shared_prefs/device_id3.xml /data/data/com.tencent.ig/shared_prefs/device_id.xml > nul 2>&1
...
adb shell touch /sdcard/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/SaveGames > nul 2>&1
...
adb shell rm -rf /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/SaveGames > nul 2>&1
...
adb shell rm -rf /data/data/com.rekoo.pubgm/databases/* > nul 2>&1
adb shell mv /data/data/com.rekoo.pubgm/shared_prefs/device_id3.xml /data/data/com.tencent.ig/shared_prefs/device_id.xml > nul 2>&1
...
adb shell touch /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/SaveGames > nul 2>&1
